...
//import xu.stat.statestix.data.Statistics.SDeviation;
//
//import static org.testng.AssertJUnit.assertEquals;
//
//public class SDeviationTest {
//
//    SDeviation sd = new SDeviation();
//    public void testFormat(double[] set, double expected) {
//        double result = sd.findSDeviation(set);
//
